(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab1-tab1-module"], {
    ...
    function node_modulesHighchartsHighchartsJs(module, exports, __webpack_require__) {
      ...
      */
      (function (T, K) {
        true && module.exports ? module.exports = T.document ? K(T) : K : T.Highcharts = K(T);
          ...
          a.Fx.prototype = {
            dSetter: function dSetter() {
              var a = this.paths[0],
                  ...
                  w = a.length,
                  l;
              if (1 === t) e = this.toD;else if (w === g.length && 1 > t) for (; w--;) {
            ...
            initPath: function initPath(r, g, e) {
              function t(a) {
                var f, c;
        ...
        (function (a) {
          ...
          a.Color.prototype = {
            ...
            init: function init(e) {
              ...
              });else if (e && e.charAt && "#" === e.charAt() && (g = e.length, e = parseInt(e.substr(1), 16), 7 === g ? w = [(e & 16711680) >> 16, (e & 65280) >> 8, e & 255, 1] : 4 === g && (w = [(e & 3840) >> 4 | (e & 3840) >> 8, (e & 240) >> 4 | e & 240, (e & 15) << 4 | e & 15, 1])), !w) for (l = this.parsers.length; l-- && !w;) {
        ...
        (function (a) {
          ...
          p(C.prototype, {
            ...
            animate: function animate(y, h, b) {
            ...
            complexColor: function complexColor(y, h, b) {
              var f = this.renderer,
                  v,
                  c,
                  d,
            ...
            css: function css(a) {
              ...
              m && (y && (a = p(y, b)), f = this.textWidth = a && a.width && "auto" !== a.width && "text" === c.nodeName.toLowerCase() && h(a.width), this.styles = a, f && !P && this.renderer.forExport && delete a.width, c.namespaceURI === this.SVG_NS ? (d = function d(a, y) {
            ...
            zIndexSetter: function zIndexSetter(a, b) {
              ...
              if (f) {
                ...
                for (p = b.length - 1; 0 <= p && !m; p--) {
                  if (v = b[p], f = v.zIndex, I = !u(f), v !== d) if (0 > a && I && !c && !p) y.insertBefore(d, b[p]), m = !0;else if (h(f) <= a || I && (!u(a) || 0 <= a)) y.insertBefore(d, b[p + 1] || null), m = !0;
                }
          ...
          p(F.prototype, {
            Element: C,
            SVG_NS: I,
            init: function init(a, h, b, c, v, f) {
              var y;
              ...
              this.setSize(h, b, !1);
              var d;
              q && a.getBoundingClientRect && (h = function h() {
                w(a, {
                  left: 0,
                  top: 0
                });
            ...
            applyEllipsis: function applyEllipsis(a, h, b, c) {
              var v = a.rotation,
                  f = b,
                  d,
                  y = 0,
            ...
            buildText: function buildText(a) {
              var c = a.element,
                ...
                b = a.indexOf(h + "\x3d");
                if (-1 !== b && (b = b + h.length + 1, h = a.charAt(b), '"' === h || "'" === h)) return a = a.substring(b + 1), a.substring(0, a.indexOf(h));
              };
            ...
            button: function button(a, h, b, c, v, f, d, m, I) {
            ...
            rect: function rect(a, h, b, c, v, f) {
              v = B(a) ? a.r : v;
            ...
            image: function image(a, h, b, c, v, f) {
              var d = {
            ...
            symbol: function symbol(a, h, b, c, v, f) {
              var d = this,
                  m,
                  I = /^url\((.*?)\)$/,
                  n = I.test(a),
              ...
              A ? (m = this.path(q), m.attr("fill", "none"), p(m, {
                ...
                width: c,
                height: v
              }), f && p(m, f)) : n && (E = a.match(I)[1], m = this.image(E), m.imgwidth = G(O[E] && O[E].width, f && f.width), m.imgheight = G(O[E] && O[E].height, f && f.height), z = function z() {
                m.attr({
                  width: m.width,
                  height: m.height
                });
            ...
            symbols: {
              circle: function circle(a, h, b, c) {
              ...
              square: function square(a, h, b, c) {
                return ["M", a, h, "L", a + b, h, a + b, h + c, a, h + c, "Z"];
              },
              triangle: function triangle(a, h, b, c) {
                return ["M", a + b / 2, h, "L", a + b, h + c, a, h + c, "Z"];
              },
              "triangle-down": function triangleDown(a, h, b, c) {
                return ["M", a, h, "L", a + b, h, a + b / 2, h + c, "Z"];
              },
              diamond: function diamond(a, h, b, c) {
                return ["M", a + b / 2, h, "L", a + b, h + c / 2, a + b / 2, h + c, a, h + c / 2, "Z"];
              },
              arc: function arc(a, h, b, c, v) {
                var f = v.start,
                    d = v.r || b,
                    m = v.r || c || b,
                    I = v.end - .001;
              ...
              callout: function callout(a, h, b, c, v) {
            ...
            clipRect: function clipRect(h, b, c, v) {
              var f = a.uniqueKey(),
            ...
            label: function label(h, b, c, f, d, m, I, n, A) {
              var k = this,
        ...
        (function (a) {
          ...
          e(a.SVGElement.prototype, {
            htmlCss: function htmlCss(a) {
              var c = this.element;
              if (c = a && "SPAN" === c.tagName && a.width) delete a.width, this.textWidth = c, this.htmlUpdateTransform();
            ...
            setSpanRotation: function setSpanRotation(a, c, b) {
              var f = {},
            ...
            getSpanCorrection: function getSpanCorrection(a, c, b) {
              this.xCorr = -a * b;
              this.yCorr = -c;
            }
          });
        ...
        (function (a) {
          ...
          a.Time.prototype = {
            ...
            makeTime: function makeTime(e, l, u, c, d, k) {
              var x, p, f;
            ...
            dateFormat: function dateFormat(e, g, u) {
            ...
            getTimeTicks: function getTimeTicks(a, l, u, c) {
              var d = this,
                  k = [],
                  x = {},
                  p,
        ...
        (function (a) {
          ...
          a.Tick.prototype = {
            ...
            handleOverflow: function handleOverflow(a) {
              var e = this.axis,
                ...
                right: 1
                  ...
                  B,
                  H = {};
              if (b || !1 === c.overflow) 0 > b && d - n * z < p ? B = Math.round(d / Math.cos(b * w) - p) : 0 < b && d + n * z > g && (B = Math.round((k - d) / Math.cos(b * w)));else if (k = d + (1 - n) * z, d - n * z < p ? q = a.x + q * (1 - n) - p : k > g && (q = g - a.x + q * n, L = -1), q = Math.min(l, q), q < l && "center" === e.labelAlign && (a.x += L * (l - q - n * (l - Math.min(z, q)))), z > q || e.autoRotation && (f.styles || {}).width) B = q;
              B && (H.width = B, (c.style || {}).textOverflow || (H.textOverflow = "ellipsis"), f.css(H));
            },
            getPosition: function getPosition(e, g, c, d) {
              var k = this.axis,
                  x = k.chart,
            ...
            getLabelPosition: function getLabelPosition(a, e, c, d, k, g, p, f) {
              var b = this.axis,
                  n = b.transA,
                  z = b.reversed,
                  x = b.staggerLines,
            ...
            getMarkPath: function getMarkPath(a, e, c, d, k, g) {
              return g.crispLine(["M", a, e, "L", a + (k ? 0 : -c), e + (k ? c : 0)], d);
            },
            renderGridLine: function renderGridLine(a, e, c) {
              var d = this.axis,
                  k = d.options,
                  g = this.gridLine,
                  p = {},
            ...
            renderMark: function renderMark(a, e, c) {
              var d = this.axis,
                  k = d.options,
                  g = d.chart.renderer,
                  p = this.type,
            ...
            renderLabel: function renderLabel(a, e, c, d) {
              var k = this.axis,
                  x = k.horiz,
                  p = k.options,
                  f = this.label,
        ...
        var V = function (a) {
          ...
          a.extend(G.prototype, {
            ...
            defaultLabelFormatter: function defaultLabelFormatter() {
              ...
              if (e) n = x(e, this, c);else if (f) n = b;else if (d) n = c.dateFormat(d, b);else if (p && 1E3 <= h) for (; p-- && void 0 === n;) {
              ...
              k(this, "getSeriesExtremes", null, function () {
                ...
                c(a.series, function (h) {
                  if (h.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) v = h.xData, v.length && (h = r(v), d = D(v), z(h) || h instanceof Date || (v = f(v, z), h = r(v), d = D(v)), v.length && (a.dataMin = Math.min(H(a.dataMin, v[0], h), h), a.dataMax = Math.max(H(a.dataMax, v[0], d), d)));else if (h.getExtremes(), d = h.dataMax, h = h.dataMin, w(h) && w(d) && (a.dataMin = Math.min(H(a.dataMin, h), h), a.dataMax = Math.max(H(a.dataMax, d), d)), w(c) && (a.threshold = c), !v.softThreshold || a.positiveValuesOnly) a.softThreshold = !1;
                  }
                });
              });
              k(this, "afterGetSeriesExtremes");
            },
            translate: function translate(a, b, c, f, d, m) {
            ...
            getPlotLinePath: function getPlotLinePath(a, b, c, f, d) {
              var h = this.chart,
                  v = this.left,
                  m = this.top,
                  I,
            ...
            getMinorTickPositions: function getMinorTickPositions() {
              ...
              });else if (a.isDatetimeAxis && "auto" === this.getMinorTickInterval()) m = m.concat(a.getTimeTicks(a.normalizeTimeTickInterval(d), p, q, b.startOfWeek));else for (b = p + (f[0] - p) % d; b <= q && b !== m[0]; b += d) {
                m.push(b);
              }
            ...
            trimTicks: function trimTicks(a, b, c) {
              ...
              if (!this.isLinked) {
                ...
                if (c) this.max = f;else for (; this.max + d < a[a.length - 1];) {
                  a.pop();
                }
            ...
            setExtremes: function setExtremes(a, b, f, m, q) {
              var h = this,
                  p = h.chart;
              f = H(f, !0);
            ...
            zoom: function zoom(a, b) {
              ...
              if (a !== this.min || b !== this.max) this.allowZoomOutside || (w(h) && (a < d && (a = d), a > f && (a = f)), w(c) && (b < d && (b = d), b > f && (b = f))), this.displayBtn = void 0 !== a || void 0 !== b, this.setExtremes(a, b, !1, void 0, {
                trigger: "zoom"
              });
              return !0;
            },
            ...
            unsquish: function unsquish() {
              ...
              b ? (E = !a.staggerLines && !a.step && (w(p) ? [p] : m < H(a.autoRotationLimit, 80) && a.autoRotation)) && c(E, function (a) {
                var b;
                if (a === p || a && -90 <= a && 90 >= a) A = z(Math.abs(n.h / Math.sin(l * a))), b = A + Math.abs(a / 360), b < k && (k = b, q = a, d = A);
              }) : a.step || (d = z(n.h));
              this.autoRotation = E;
            ...
            renderUnsquish: function renderUnsquish() {
              ...
              if (this.autoRotation) g > n && g > A.h ? e.rotation = this.labelRotation : this.labelRotation = 0;else if (p && (E = n, !k)) for (z = "clip", n = f.length; !q && n--;) {
                if (B = f[n], B = d[B].label) B.styles && "ellipsis" === B.styles.textOverflow ? B.css({
                  textOverflow: "clip"
        ...
        (function (a) {
          ...
          C.prototype.getLogTickPositions = function (a, t, w, l) {
            ...
            if (.5 <= a) a = Math.round(a), d = this.getLinearTickPositions(a, t, w);else if (.08 <= a) for (var c = Math.floor(t), k, x, p, f, b, e = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; c < w + 1 && !b; c++) {
              for (x = e.length, k = 0; k < x && !b; k++) {
                p = this.log2lin(this.lin2log(c) * e[k]), p > t && (!l || f <= w) && void 0 !== f && d.push(f), f > w && (b = !0), f = p;
              }
            } else t = this.lin2log(t), w = this.lin2log(w), a = l ? this.getMinorTickInterval() : e.tickInterval, a = g("auto" === a ? null : a, this._minorAutoInterval, e.tickPixelInterval / (l ? 5 : 1) * (w - t) / ((l ? c / this.tickPositions.length : c) || 1)), a = r(a, null, F(a)), d = D(this.getLinearTickPositions(a, t, w), this.log2lin), l || (this._minorAutoInterval = a / 5);
        ...
        (function (a, C) {
          ...
          a.PlotLineOrBand.prototype = {
            ...
            renderLabel: function renderLabel(a, c, d, e) {
              var k = this.label,
          ...
          a.extend(C.prototype, {
            getPlotBandPath: function getPlotBandPath(a, c) {
              ...
              if (e && d) for (a && (b = e.toString() === d.toString(), f = 0), a = 0; a < e.length; a += 6) {
            ...
            addPlotBandOrLine: function addPlotBandOrLine(e, c) {
            ...
            removePlotBandOrLine: function removePlotBandOrLine(a) {
              for (var c = this.plotLinesAndBands, d = this.options, k = this.userOptions, g = c.length; g--;) {
        ...
        (function (a) {
          ...
          a.Tooltip.prototype = {
            ...
            getDateFormat: function getDateFormat(a, d, e, g) {
        ...
        (function (a) {
          ...
          a.Pointer.prototype = {
            ...
            findNearestKDPoint: function findNearestKDPoint(a, c, f) {
              var b;
              t(a, function (a) {
            ...
            getHoverData: function getHoverData(b, c, f, e, p, g, k) {
              var q,
                  m = [],
                  n = k && k.isBoosting;
              e = !(!e || !b);
        ...
        (function (a) {
          ...
          D(a.Pointer.prototype, {
            pinchTranslate: function pinchTranslate(a, e, g, r, c, d) {
              this.zoomHor && this.pinchTranslateDirection(!0, a, e, g, r, c, d);
              this.zoomVert && this.pinchTranslateDirection(!1, a, e, g, r, c, d);
            },
            pinchTranslateDirection: function pinchTranslateDirection(a, e, g, r, c, d, k, x) {
              var p = this.chart,
                  f = a ? "x" : "y",
                  b = a ? "X" : "Y",
                  n = "chart" + b,
        ...
        (function (a) {
          ...
          x(P.prototype, {
            ...
            setSize: function setSize(b, d, h) {
              var m = this,
                  e = m.renderer;
              m.isResizing += 1;
              a.setAnimation(h, m);
            ...
            drawChartBox: function drawChartBox() {
              ...
              if (g || h["stroke-width"]) k.stroke = a.borderColor, k["stroke-width"] = g;
        ...
        (function (a) {
          ...
          a.Point.prototype = {
            ...
            setNestedProperty: function setNestedProperty(c, d, e) {
              e = e.split(".");
            ...
            optionsToObject: function optionsToObject(c) {
              var d = {},
                  ...
                  b = 0,
                  n = 0;
              if (w(c) || null === c) d[p[0]] = c;else if (t(c)) for (!g && c.length > f && (e = typeof c[0], "string" === e ? d.name = c[0] : "number" === e && (d.x = c[0]), b++); n < f;) {
            ...
            firePointEvent: function firePointEvent(a, d, e) {
              var c = this,
        ...
        (function (a) {
          ...
          a.Series = a.seriesType("line", null, {
            ...
            generatePoints: function generatePoints() {
              ...
              this.options.keys = a;
              if (c && (g !== (d = c.length) || n)) for (t = 0; t < d; t++) {
            ...
            getExtremes: function getExtremes(a) {
              ...
              for (l = 0; l < d; l++) {
                if (q = c[l], n = a[l], g = (p(n, !0) || x(n)) && (!b.positiveValuesOnly || n.length || 0 < n), q = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[l + k] || q) >= e && (c[l - k] || q) <= m, g && q) if (g = n.length) for (; g--;) {
        ...
        (function (a) {
          ...
          a.StackItem.prototype = {
            ...
            getStackBox: function getStackBox(a, d, e, g, p, f, b) {
        ...
        (function (a) {
          ...
          l(a.Chart.prototype, {
            ...
            update: function update(a, g, m, q) {
              var k = this,
                  n = {
                credits: "addCredits",
                title: "setTitle",
              ...
              t("xAxis yAxis zAxis series colorAxis pane".split(" "), function (b) {
                a[b] && (t(L(a[b]), function (a, c) {
                  ...
                  if (!c && m) if ("series" === b) k.addSeries(a, !1).touched = !0;else if ("xAxis" === b || "yAxis" === b) k.addAxis(a, "xAxis" === b, !1).touched = !0;
                }), m && t(k[b], function (a) {
          ...
          l(z.prototype, {
            addPoint: function addPoint(a, c, d, f) {
              ...
              t = k.x;
              l = p.length;
              if (this.requireSorting && t < p[l - 1]) for (n = !0; l && p[l - 1] > t;) {
                l--;
              }
        ...
        (function (a) {
          ...
          a = a.seriesType;
          a("spline", "line", {}, {
            getPointSpline: function getPointSpline(a, D, r) {
              var g = D.plotX,
                  e = D.plotY,
                  t = a[r - 1];
              r = a[r + 1];
        ...
        (function (a) {
          ...
          l("column", "line", {
            ...
            crispCol: function crispCol(a, d, e, g) {
              var c = this.chart,
                  f = this.borderWidth,
                  b = -(f % 2 ? .5 : 0),
                  f = f % 2 ? .5 : 1;
            ...
            drawPoints: function drawPoints() {
              ...
              D(a.points, function (b) {
                ...
                if (g(b.plotY) && null !== b.y) {
                  f = b.shapeArgs;
                  if (c) c[t](e(f));else b.graphic = c = l[b.shapeType](f).add(b.group || a.group);
          ...
          k.pie && (k.pie.prototype.drawDataLabels = function () {
            ...
            c.visible && (k.enabled || c._hasPointLabels) && (r(b, function (a) {
              ...
              if ((h = a.dataLabel) && h._pos && a.visible && 0 < a.labelDistance) {
                ...
                if (b = !w) a.connector = w = g.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + a.colorIndex + (a.className ? " " + a.className : "")).add(c.dataLabelsGroup), w.attr({
                  "stroke-width": l,
        ...
        (function (a) {
          ...
          C.prototype.hideOverlappingLabels = function (a) {
            var e = a.length,
                ...
                x,
                p,
                f = function f(a, c, d, e, _f, g, k, l) {
              return !(_f > a + d || _f + k < a || g > c + e || g + l < c);
            };
            ...
            for (r = 0; r < e; r++) {
              for (l = a[r], g = r + 1; g < e; ++g) {
                if (u = a[g], l && u && l !== u && l.placed && u.placed && 0 !== l.newOpacity && 0 !== u.newOpacity && (c = l.alignAttr, d = u.alignAttr, k = l.parentGroup, x = u.parentGroup, p = 2 * (l.box ? 0 : l.padding || 0), c = f(c.x + k.translateX, c.y + k.translateY, l.width - p, l.height - p, d.x + x.translateX, d.y + x.translateY, u.width - p, u.height - p))) (l.labelrank < u.labelrank ? l : u).newOpacity = 0;
              }
            }
          ...
          w(f.prototype, {
            ...
            setState: function setState(a, b) {
              ...
              if (!(a === this.state && !b || this.selected && "select" !== a || !1 === g.enabled || a && (h || q && !1 === n.enabled) || a && t.states && t.states[a] && !1 === t.states[a].enabled)) {
                ...
                if (this.graphic) this.state && this.graphic.removeClass("highcharts-point-" + this.state), a && this.graphic.addClass("highcharts-point-" + a), this.graphic.animate(f.pointAttribs(this, a), p(u.options.chart.animation, g.animation)), z && this.graphic.animate(z, p(u.options.chart.animation, n.animation, k.animation)), r && r.hide();else {
                  if (a && n) {
                    k = t.symbol || f.symbol;
          ...
          w(b.prototype, {
            ...
            setState: function setState(a) {
              ...
              if (b.state !== a && (t([b.group, b.markerGroup, b.dataLabelsGroup], function (c) {
                ...
                "stroke-width": f
              }, d.animate(f, p(e[a || "normal"] && e[a || "normal"].animation, b.chart.options.chart.animation)); b["zone-graph-" + c];) {
          ...
          C.prototype.currentOptions = function (e) {
            function l(c, d, e, u) {
              ...
              a.objectEach(c, function (a, b) {
                if (!u && -1 < D(b, ["series", "xAxis", "yAxis"])) for (a = t(a), e[b] = [], k = 0; k < a.length; k++) {
    ...
    /***/
    function node_modulesHighchartsModulesExportingJs(module, exports, __webpack_require__) {
      /*
       Highcharts JS v6.1.0 (2018-04-13)
       Exporting module
      ...
      */
      (function (h) {
        true && module.exports ? module.exports = h : h(Highcharts);
      })(function (h) {
        (function (f) {
    ...
    function node_modulesRawLoaderDistCjsJsSrcAppTab1Tab1PageHtml(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "<ion-header [translucent]=\"true\">\n  <ion-toolbar>\n    <div class=\"toolbar\">\n    <img src=\"../assets/icon/1.png\" class=\"imagem\"/>\n  </div>\n  </ion-toolbar>\n</ion-header>\n\n\n<ion-content [fullscreen]=\"true\">\n\n  <ion-header collapse=\"condense\">\n    <ion-toolbar>\n      <ion-title size=\"large\">Home</ion-title>\n    </ion-toolbar>\n  </ion-header>\n  <ion-row>\n    <ion-col size=\"12\" class=\"promocoes\">\n      <ion-slides pager>\n        <ion-slide *ngFor=\"let ban of banners\">\n\n            <ion-card-content class=\"bg\">\n              <ion-img [src]=\"ban.imagem\"></ion-img>\n            </ion-card-content>\n          \n        </ion-slide>\n       </ion-slides>\n    </ion-col>\n    <ion-col size=\"6\" class=\"infracoes\">\n      <div class=\"container-fluid p-5\">\n        <div #infracao>\n        </div>\n      </div>\n    </ion-col>\n    <ion-col size=\"6\" class=\"suspensoes\">\n      <div class=\"container-fluid p-5\">\n        <div #suspensao>\n        </div>\n      </div>\n    </ion-col>\n    <ion-col size=\"8\" offset=\"2\" class=\"cassacoes\">\n      <div class=\"container-fluid p-5\">\n        <div #cassacao>\n        </div>\n      </div>\n    </ion-col>\n    <ion-col size=\"12\" class=\"sos\">\n      <h1 class=\"news\">Noticias</h1>\n      <ion-slides>\n        <ion-slide *ngFor=\"let not of noticias\">\n\n            <ion-card-content class=\"bg1\">\n              <ion-img [src]=\"not.imagem\"></ion-img>\n              <div class=\"titulo\">{{not.titulo}}</div>\n              <div class=\"resumo\">{{not.resumo}}</div>\n              <div class=\"saibamais\"> <a href=\"#\">{{not.btnMsg}}</a></div>\n            </ion-card-content>\n          \n        </ion-slide>\n       </ion-slides>\n      </ion-col>\n    <ion-col size=\"12\" class=\"parcerias\">\n      <h1 class=\"comerciais\">Parceiros Comerciais</h1>\n      <ion-slides>\n        <ion-slide *ngFor=\"let patro of patrocinadores\">\n            <ion-card-content class=\"bg2\">\n              <ion-img [src]=\"patro.imagem\"></ion-img>\n            </ion-card-content>\n          \n        </ion-slide>\n       </ion-slides>\n    </ion-col>\n    <ion-footer class=\"ion-no-border\">\n      <img src=\"assets/imagens/11.png\" class=\"rodape\"/>   \n    </ion-footer>\n  </ion-row>\n\n</ion-content>\n";
      /***/
    },

    /***/
    "./src/app/service/noticia.service.ts":
    /*!********************************************!*\
      !*** ./src/app/service/noticia.service.ts ***!
      \********************************************/
    ...
    /***/
    function srcAppServiceNoticiaServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _noticia__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./noticia */
      "./src/app/service/noticia.ts");
      /* harmony import */
      ...
      var NoticiaService = /*#__PURE__*/function () {
        function NoticiaService() {
          ...
          this.noticias = [];
          this.noticias = _noticia__WEBPACK_IMPORTED_MODULE_1__["listaNoticia"];
        }
      ...
      NoticiaService.ctorParameters = function () {
        return [];
      };

      NoticiaService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
        providedIn: 'root'
      })], NoticiaService);
      /***/
    },
    ...
    /*! exports provided: listaNoticia */

    /***/
    function srcAppServiceNoticiaTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "listaNoticia", function () {
        return listaNoticia;
      });

      var listaNoticia = [{
        "idNoticia": 1,
        "imagem": "assets/imagens/noticia/1.jpeg",
        "titulo": "CONSULTORIA ESPECIALIZADA",
        "resumo": "O mutirão do Detran.RJ que acontece no próximo fim de semana, dias 24 e 25 de outubro...",
        "btnMsg": "Saiba Mais",
        "link": ""
      }, {
        "idNoticia": 2,
        "imagem": "assets/imagens/noticia/2.jpeg",
        "titulo": "DETRAN REABRE MAIS TRÊS UNIDADES DE SERVIÇO VEICULAR",
        "resumo": "Mais de seis mil vagas mensais serão disponibilizadas...",
        "btnMsg": "Saiba Mais",
        "link": ""
      }];
      /***/
    ...
    /***/
    "./src/app/service/patrocinador.service.ts":
    /*!*************************************************!*\
      !*** ./src/app/service/patrocinador.service.ts ***!
      \*************************************************/

    /*! exports provided: PatrocinadorService */

    /***/
    function srcAppServicePatrocinadorServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PatrocinadorService", function () {
      ...
      var _patrocinador__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./patrocinador */
      "./src/app/service/patrocinador.ts");

      var PatrocinadorService = /*#__PURE__*/function () {
        function PatrocinadorService() {
          _classCallCheck(this, PatrocinadorService);

          this.patrocinadores = [];
          this.patrocinadores = _patrocinador__WEBPACK_IMPORTED_MODULE_2__["listaPatrocinadores"];
        }

        _createClass(PatrocinadorService, [{
          key: "findAll",
          value: function findAll() {
      ...
      PatrocinadorService.ctorParameters = function () {
        return [];
      };

      PatrocinadorService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], PatrocinadorService);
      /***/
    },
    ...
    /*! exports provided: listaPatrocinadores */

    /***/
    function srcAppServicePatrocinadorTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "listaPatrocinadores", function () {
        return listaPatrocinadores;
      });

      var listaPatrocinadores = [{
        "idPatrocinador": 1,
        "imagem": "assets/imagens/patrocinador/parceiros2 (1).jpeg"
      }, {
        "idPatrocinador": 2,
        "imagem": "assets/imagens/patrocinador/parceiros1.jpeg"
      }];
      /***/
    },
    ...
    function srcAppTab1Tab1ModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      Tab1PageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        imports: [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonicModule"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _explore_container_explore_container_module__WEBPACK_IMPORTED_MODULE_6__["ExploreContainerComponentModule"], angular_bootstrap_md__WEBPACK_IMPORTED_MODULE_8__["MDBBootstrapModule"].forRoot(), _tab1_routing_module__WEBPACK_IMPORTED_MODULE_7__["Tab1PageRoutingModule"]],
    ...
    function srcAppTab1Tab1PageScss(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = ".toolbar {\n  background-color: black;\n  height: 60px;\n  align-items: center;\n  padding-top: 15px;\n}\n\n.imagem {\n  display: block;\n  margin-left: auto;\n  margin-right: auto;\n  width: 80px;\n}\n\n.promocoes {\n  text-align: center;\n}\n\n.infracoes {\n  text-align: center;\n}\n\n.suspensoes {\n  text-align: center;\n}\n\n.cassacoes {\n  text-align: center;\n}\n\n.sos {\n  text-align: center;\n}\n\n.parcerias {\n  text-align: center;\n}\n\n.banner {\n  display: block;\n  margin-left: auto;\n  margin-right: auto;\n  -o-object-fit: cover;\n     object-fit: cover;\n  -o-object-position: top;\n     object-position: top;\n  height: 600px;\n  background-size: cover;\n  width: 100%;\n}\n\n.bg {\n  width: 400px;\n  height: 300px;\n  padding-left: 0;\n  padding-right: 0;\n  padding-top: 0;\n}\n\n.bg1 {\n  width: 300px;\n  height: 300px;\n  padding-left: 0;\n  padding-right: 0;\n  padding-top: 0;\n  text-align: left;\n}\n\n.ion-img {\n  width: 10px;\n  height: 50px;\n}\n\n.titulo {\n  color: #c8471e;\n  margin-top: 8px;\n  font-size: 18px;\n  font-weight: bold;\n  font-family: \"Lato\", sans-serif;\n  line-height: 1.2;\n}\n\n.resumo {\n  font-family: \"Lato\", sans-serif;\n  color: #636066;\n}\n\n.saibamais {\n  text-align: right;\n  margin-bottom: 10px;\n}\n\n.bg2 {\n  opacity: 0.5;\n}\n\n.comerciais {\n  margin-top: 10px;\n  font-family: \"Lato\", sans-serif;\n}\n\n.news {\n  margin-bottom: 20px;\n  font-family: \"Lato\", sans-serif;\n}\n\n.rodape {\n  display: block;\n  margin-left: auto;\n  margin-right: auto;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
    ...
    function srcAppTab1Tab1PageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _service_patrocinador_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./../service/patrocinador.service */
      "./src/app/service/patrocinador.service.ts");
      /* harmony import */


      var _service_noticia_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./../service/noticia.service */
      "./src/app/service/noticia.service.ts");
      /* harmony import */
      ...
      var _service_banner_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../service/banner.service */
      "./src/app/service/banner.service.ts");
      /* harmony import */


      var highcharts_modules_exporting__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! highcharts/modules/exporting */
      "./node_modules/highcharts/modules/exporting.js");
      /* harmony import */


      var highcharts_modules_exporting__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(highcharts_modules_exporting__WEBPACK_IMPORTED_MODULE_5__);
      /* harmony import */
      ...
      highcharts_modules_exporting__WEBPACK_IMPORTED_MODULE_5__(highcharts__WEBPACK_IMPORTED_MODULE_6__);

      var Tab1Page = /*#__PURE__*/function () {
        function Tab1Page(service, serviceNoticia, servicePatrocinador) {
          _classCallCheck(this, Tab1Page);

          this.service = service;
          this.serviceNoticia = serviceNoticia;
          this.servicePatrocinador = servicePatrocinador;
          this.banners = [];
          this.noticias = [];
          this.patrocinadores = [];
        }
        ...
        _createClass(Tab1Page, [{
          ...
          value: function ngAfterViewInit() {
            ...
            this.chart = Object(highcharts__WEBPACK_IMPORTED_MODULE_6__["chart"])(this.chartTarget.nativeElement, options);
            this.chart = Object(highcharts__WEBPACK_IMPORTED_MODULE_6__["chart"])(this.chartTarget2.nativeElement, options2);
            this.chart = Object(highcharts__WEBPACK_IMPORTED_MODULE_6__["chart"])(this.chartTarget3.nativeElement, options3);
          }
        }]);
      ...
      Tab1Page.ctorParameters = function () {
        return [{
          type: _service_banner_service__WEBPACK_IMPORTED_MODULE_4__["BannerService"]
        }, {
          type: _service_noticia_service__WEBPACK_IMPORTED_MODULE_2__["NoticiaService"]
        }, {
          type: _service_patrocinador_service__WEBPACK_IMPORTED_MODULE_1__["PatrocinadorService"]
        }];
      };
